                    ...
                    <div class="col-md-12">
                        <form action="{{ url("/admin/article/update/$article->id") }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group__inner">
                                    ...
                                    <select name="keywords[]"
                                        ...
                                        @foreach($article->keywords as $keyword)
                                            <option value="{{ $keyword->id }}" selected="selected">{{ $keyword->keyword }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group__inner">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview" data-trigger="fileinput">
                                            <img src="{{ asset($article->page_image) }}">
                                        </div>
                            ...
                            <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                                <div class="form-group__inner">
                                    <label>文章</label>
                                    <textarea name="content" id="simplemde">{{ $article->content }}</textarea>
                                </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn--light btn-lg">修改</button>
                            </div>
