    ...
    <section class="section-body">
        ...
        @if($prev_article || $next_article)
            <nav class="navigation post-navigation" role="navigation">
                ...
                <div class="nav-links">
                    @if($prev_article)
                        <div class="nav-previous" style="background-image: url({{ asset($prev_article->page_image) }})">
                    ...
                    @endif
                    @if($next_article)
                        <div class="nav-next" style="background-image: url({{ asset($next_article->page_image) }})">
