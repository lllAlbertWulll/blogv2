    ...
    $("#data-table-command").bootgrid({
        ...
        formatters: {
            "commands": function(column, row) {
                return "<a href=\"/admin/article/recovery/" + row.id + "\" type=\"button\" class=\"btn btn-default btn-sm\">恢复</a> " +
                "<a href=\"/admin/article/destroy/" + row.id + "\" type=\"button\" class=\"btn btn-default btn-sm\">永久删除</a>";
            }
        }
    });
});