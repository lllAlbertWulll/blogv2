    ...
    $("#data-table-command").bootgrid({
        ...
        formatters: {
            "commands": function(column, row) {
                return "<a href=\"/admin/article/edit/" + row.id + "\" type=\"button\" class=\"btn btn-default btn-sm\">编辑</a> " +
                    "<a href=\"/admin/article/delete/" + row.id + "\" type=\"button\" class=\"btn btn-default btn-sm\">删除</a>";
            }
        }
    });
});