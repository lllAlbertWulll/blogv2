    ...
    $("#data-table-command").bootgrid({
        ...
        formatters: {
            "commands": function(column, row) {
                return "<a href=\"/admin/comment/recovery/" + row.id + "\" type=\"button\" class=\"btn btn-default btn-sm\">恢复</a> " +
                "<a href=\"/admin/comment/destroy/" + row.id + "\" type=\"button\" class=\"btn btn-default btn-sm\">永久删除</a>";
            }
        }
    });
});